...
public class Servidor extends Thread{ //Servidor é um tipo de Thread
    ...
    /* Quando um cliente envia uma mensagem, o servidor recebe e manda esta para todos os outros clientes conectados. 
      E que para isso é necessário percorrer a lista de clientes e mandar uma cópia da mensagem para cada um. */
    ...
    // Método Main
    /* ao iniciar o servidor, fará a configuração do servidor socket e sua respectiva porta. Vejamos que ele começa criando uma janela para informar a porta e depois entra no “while(true)”.
     Na linha “server.accept()” o sistema fica bloqueado até que um cliente socket se conecte: se ele fizer isso é criada uma nova Thread do tipo servidor. */
    /* Lembrando que a classe servidor é um tipo de Thread e é iniciada na instrução “t.start()”. Então o controle do fluxo retorna para a linha “server.accept()” e aguarda outro cliente 
     se conectar. */
